  ...
  const careers = [
    {
      role: "C++ Developer",
      salary: "₹4–10 LPA",
      desc: "Develop high-performance applications using C++ programming.",
    },
    {
      role: "Software Engineer",
      salary: "₹5–15 LPA",
      desc: "Build scalable software systems and applications.",
    },
    {
      role: "Game Developer",
      salary: "₹4–12 LPA",
      desc: "Create games and game engines using C++.",
    },
    {
      role: "Competitive Programmer",
      salary: "₹5–20 LPA",
      desc: "Solve complex programming problems using algorithms.",
    },
  ];
      ...
      <div className="bg-slate-900 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-gray-400 mt-4 text-lg">
            C++ is a powerful programming language used in software
            development, game development, competitive programming,
