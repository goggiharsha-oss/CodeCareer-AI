...
function CareerQuiz() {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      const bestCareer = Object.keys(careerCount).reduce((a, b) =>
  ...
  return (
    <div
      className={`relative min-h-screen overflow-hidden flex items-center justify-center px-6 transition-all duration-500 ${
        darkMode
      ...
      <div className="relative z-10 w-full max-w-3xl">
        ...
        {showResult ? (
          ...
          >
            ...
            <div className="mt-8 flex justify-center">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm mt-2">Match Score</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-5 mt-8">
              {[
                ...
                >
                  ...
                  <h3 className="font-semibold text-cyan-400">{card.title}</h3>
            ...
            >
              Based on your interests and answers, our AI recommends this career
              path as the best fit for your future.
            </p>
            ...
            <motion.button
              onClick={() => navigate(`/roadmap/${resultCareer}`)}
              whileHover={{
                scale: 1.08,
              }}
              whileTap={{
              ...
              "
            >
              <span className="flex items-center gap-2">🚀 View Roadmap</span>
            </motion.button>
          </motion.div>
        ) : !started ? (
          /* =====================================================
          ...
          >
            ...
            <p className="mt-6 text-lg">
              Answer simple questions and discover your best programming career
              path.
            </p>
